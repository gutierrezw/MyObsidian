...
- **Estado:** 4 archivos modificados sin comitear (`Class_DashBot.py`, `Class_IA_modelos.py`, `Class_SystemStatus.py`, `Modulos_Mysql.py`) + `ref-oportunidades.md` en el repo del vault. Pendiente de autorización del usuario.
